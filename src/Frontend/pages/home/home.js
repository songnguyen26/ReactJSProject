...
function Home(){
    ...
    const [promotionProduct,setPromotionProducts]=useState([])
    useEffect(()=>{
        apiProduct.getPromotion().then((res)=>{
            try{
                ...
                // console.log("product:",promotionProductData);
           ...
           <div className="container">
               <div className="row p-5">
                   <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                       <img className="img-fluid" src="src/Frontend/assets/img/banner_img_01.jpg" alt=""/>
                   </div>
...
<section className="container py-5">
   <div className="row text-center pt-3">
       <div className="col-lg-6 m-auto">
           <h1 className="h1">Newest Product</h1>
           <p>
   ...
   <div className="row text-center pt-3">
       <div className="col-lg-6 m-auto">
           <h1 className="h1">Promotion Product</h1>
           <p>
               Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
               deserunt mollit anim id est laborum.
           </p>
   ...
   <div className="row">
   {
            promotionProduct.map((product,index)=>{
                return (
                    <ProductItem key={index} product={product}/>
                )
            })
